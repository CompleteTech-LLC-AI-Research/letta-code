...
Create Options:
  ...
  --personality <name>  Personality preset: letta-code, linus, kawaii, caveman (CaveCode), claude, codex
...
async function runCreateAction(
  ...
  if (personalityInput && !personality) {
    console.error(
      `Unknown personality: ${personalityInput}. Valid: letta-code, linus, kawaii, caveman (CaveCode), claude, codex`,
    );
    return 1;
  }
